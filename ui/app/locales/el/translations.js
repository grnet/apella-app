export default {
  ...
  'nomination_act.hint': 'Το πεδίο "Πράξη διορισμού" μπορεί να συμπληρωθεί μόνο εάν είναι συμπληρωμένο το πεδίο "Διαβιβαστικό πρακτικού επιλογής προς τον Πρύτανη".',
