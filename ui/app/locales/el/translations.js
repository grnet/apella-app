export default {
  ...
  candidacy: {
    ...
    candidate_section: {
      ...
      subtitle_candidate: 'Τα παρακάτω στοιχεία μπορούν να τροποποιηθούν μόνο από την καρτέλα Προφίλ.'
    },
    candidacy_section: {
  ...
  fieldsets:{
    labels: {
      ...
      user_interest: 'Εκδήλωση ενδιαφέροντος',
      ...
      electors: 'Εκλεκτορικό Σώμα',
    },
    text: {
      user_interest: 'Εκδηλώστε το ενδιαφέρον σας',
      manager_can_edit: 'Τα ακόλουθα πεδία μπορούν να επεξεργαστούν μόνο από τον διαχειριστή του ιδρύματος.',
      ...
      candidate_profile: 'Για να ενημερώσετε τις ενεργές υποψηφιότητές σας με τις αλλαγές που κάνετε στα πεδία "Βιογραφικό", "Διπλώματα" και "Δημοσιεύσεις", θα πρέπει να επιλέξετε το κουμπί "Ενημέρωση Υποψηφιοτήτων", που βρίσκεται στο πάνω μέρος της σελίδας.',
    }
  },
  institution: {
