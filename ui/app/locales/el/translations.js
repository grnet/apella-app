export default {
  ...
  'old.user.info': 'Εάν είστε <strong>χρήστης της παλιάς εφαρμογής</strong>, μπορείτε να συνδεθείτε στον υφιστάμενο λογαριασμό σας, με έναν από τους παρακάτω τρόπους:<ul><li class="md-padding">Εάν χρησιμοποιείτε προσωπικά ή ιδρυματικά διαπιστευτήρια (username και password) για να συνδεθείτε στην παλιά εφαρμογή, θα πρέπει να χρησιμοποιήσετε τα ίδια διαπιστευτήρια.</li><li class="md-padding">Εάν χρησιμοποιείτε προσωπικό σύνδεσμο εισόδου για να συνδεθείτε στην παλιά εφαρμογή, θα πρέπει να χρησιμοποιήσετε τα διαπιστευτήρια (username και password) που λάβατε σε e-mail.<br>Εάν δεν έχετε λάβει το e-mail με τα προσωπικά σας διαπιστευτήρια, παρακαλούμε επικοινωνήστε με το <a href="https://apella.minedu.gov.gr/contact">Γραφείο Αρωγής Χρηστών</a>.</li></ul>',
