export default {
  ...
  'login.login.description': 'Είσοδος μόνο για Καθηγητές/Ερευνητές αλλοδαπής, Υποψηφίους, Διαχειριστές και Βοηθούς Ιδρύματος',
  'login.domestic.title': 'Είσοδος μέσω οικείου φορέα',
  'login.domestic.description': 'Είσοδος μόνο για Καθηγητές/Ερευνητές Ημεδαπής',
  'login.domestic.label': 'Εισοδος μεσω οικειου φορεα',

   // register
  'register': 'Εγγραφή',
  'register.title': 'Εγγραφή',
  'register.description': 'Eπιλέξτε το είδος της εγγραφής σας',
  ...
  'verify.user.title': 'Verify user title *',
  'verify.user.message': 'Verify user message *',
  ...
  'reject.user.title': 'Reject user title*',
