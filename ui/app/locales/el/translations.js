export default {
  ...
  'afterToday.message': 'H ημερομηνία θα πρέπει να είναι μελλοντική',
  'beforeToday.message': 'H ημερομηνία θα πρέπει να είναι παρελθοντική',
  'urlStarts.message': 'Ο σύνδεσμος θα πρέπει να ξεκινά με http ή https',
  'ends30After.message': 'Η ημερομηνία λήξης θα πρέπει να είναι τουλάχιστον μετά από 30 μέρες από την ημερομηνία εναρξης',
