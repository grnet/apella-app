export default {
  ...
  'fieldsets.text.user_application_create': 'Μπορείτε να επιλέξετε παρακάτω το είδος της αίτησης που θέλετε να υποβάλετε.<br> Σημειώνεται ότι η υποβολή της αίτησης δεν ισοδυναμεί με υποψηφιότητα.<br>  Θα πρέπει να υποβάλετε την υποψηφιότητας σας αφού το Τμήμα σας εγκρίνει την αίτησης σας και δημιουργήσει την αντίστοιχη θέση μονιμοποίησης/ανανέωσης θητείας.',
