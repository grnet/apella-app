export default {
  ...
  'already.in.registry': 'Υπάρχει ήδη στο μητρώο',
  ...
  'candidacy.label.pubs_note': 'Υπόμνημα επιστημονικών δημοσιεύσεων',
  ...
  'error.for.users': 'Σφάλμα για τους χρήστες: ',
  ...
  'fieldsets.labels.user_application_create.applicant': 'Αίτηση μονιμοποίησης/ανανέωσης θητείας',
  'fieldsets.labels.user_application_create.helpdesk': 'Αίτηση μετακίνησης',
  ...
  'in.other.registry': 'Yπάρχει ήδη σε άλλο μητρώο του ίδιου τμήματος',
  ...
  'pubs_note.label': 'Υπόμνημα επιστημονικών δημοσιεύσεων',
  'rank.label': 'Βαθμίδα',
  ...
  'user_department.title_current.label': 'Τμήμα χρήστη',
  'user_id.label': 'Κωδικός χρήστη',
  'user_institution.title_current.label': 'Ίδρυμα χρήστη',
