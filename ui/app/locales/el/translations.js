export default {
  ...
  'prompt.cancelPosition.message': 'Είστε βέβαιος/η ότι θέλετε να ακυρώσετε τη θέση;',
  ...
  fieldsets:{
    ...
    text: {
      ...
      electors: '<p>Τα μέλη του εκλεκτορικού σώματος μπορούν να προστεθούν μόνο εάν είναι συμπληρωμένο το πεδίο "Απόφαση σύστασης εκλεκτορικού σώματος".</p><ul><li>Εάν το Τμήμα στο οποίο ανήκει η θέση αριθμεί πάνω από 40 Καθηγητές και Λέκτορες το εκλεκτορικό σώμα πρέπει να αποτελείται από ακριβώς 15 τακτικά και 15 αναπληρωματικά μέλη.</li><li>Τα 7 από τα 15 τακτικά μέλη πρέπει να προέρχονται από το μητρώο εσωτερικών μελών του Τμήματος της θέσης και τα υπόλοιπα 8 από το μητρώο εξωτερικών μελών του Τμήματος. Ο ίδιος κανόνας εφαρμόζεται και στα αναπληρωματικά μέλη. </li><li>Εάν το Τμήμα στο οποίο ανήκει η θέση αριθμεί κάτω από 40 Καθηγητές και Λέκτορες το εκλεκτορικό σώμα πρέπει να αποτελείται από ακριβώς 11 τακτικά και 11 αναπληρωματικά μέλη.</li><li>Τα 5 από τα 11 τακτικά μέλη πρέπει να προέρχονται από το μητρώο εσωτερικών μελών του Τμήματος της θέσης και τα υπόλοιπα 6 από το μητρώο εξωτερικών μελών του Τμήματος. Ο ίδιος κανόνας εφαρμόζεται και στα αναπληρωματικά μέλη.</li></ul>',
    }
  },
  institution: {
  ...
  '{description} must be between {min} and {max} characters': 'To πεδίο \'{description}\' πρέπει να είναι μεταξύ {min} και {max} χαρακτήρων',
  '{description} must be an integer': 'To πεδίο \'{description}\' δέχεται μόνο αριθμητικούς χαρακτήρες',
  '{description} must be a number': 'To πεδίο \'{description}\' πρέπει να είναι αριθμός',
