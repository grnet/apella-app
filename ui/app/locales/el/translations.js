export default {
  ...
  'fieldsets.text.leave': 'Η γραμματεία του οικείου Τμήματος έχει δηλώσει την παρακάτω άδεια.<br> Κατά το διάστημα της άδειας, υπάρχει κώλυμα συμμετοχής σε εκλεκτορικό σώμα.',
