export default {
  ...
  'disable.professor': 'Απενεργοποίηση καθηγητή',
  'disable.professor.self': 'Απενεργοποιηση',
  'disable.professor.error': 'Σφάλμα κατά την απενεργοποίηση καθηγητή',
  'disable.professor.message': 'O χρήστης που θα απενεργοποιηθεί: <ul><li> δεν είναι ορατός για προσθήκη σε μητρώο</li><li> δεν είναι ορατός για προσθήκη σε εκλεκτορικό σώμα/εισηγητική επιτροπή (από μητρώα στα οποία ήδη συμμετέχει)</li><li> εξακολουθεί να έχει πρόσβαση στο λογαριασμό του και σε όλες τις λειτουργίες που προβλέπονται για το ρόλο του</li><li> εξακολουθεί να εμφανίζεται σε όσα μητρώα/εκλεκτορικά σώματα/επιτροπές συμμετέχει</li></ul>Eπιθυμείτε να συνεχίσετε;',
  'disable.professor.message.self': 'O χρήστης που θα απενεργοποιηθεί: <ul><li> δεν είναι ορατός για προσθήκη σε μητρώο</li><li> δεν είναι ορατός για προσθήκη σε εκλεκτορικό σώμα/εισηγητική επιτροπή (από μητρώα στα οποία ήδη συμμετέχει)</li><li> εξακολουθεί να έχει πρόσβαση στο λογαριασμό του και σε όλες τις λειτουργίες που προβλέπονται για το ρόλο του</li><li> εξακολουθεί να εμφανίζεται σε όσα μητρώα/εκλεκτορικά σώματα/επιτροπές συμμετέχει</li></ul>Eπιθυμείτε να συνεχίσετε;',
  'disable.professor.success': 'Επιτυχής απενεργοποίηση καθηγητή',
  'disable.professor.title': 'Απενεργοποίηση καθηγητή',
