export default {
  ...
  'afterToday.message': 'H ημερομηνία θα πρέπει να είναι προγενέστερη της σημερινής',
  'beforeToday.message': 'H ημερομηνία θα πρέπει να είναι μεταγενέστερη της σημερινής',
  'urlStarts.message': 'Ο σύνδεσμος θα πρέπει να ξεκινά με http ή https',
  'ends30After.message': 'Η ημερομηνία λήξης θα πρέπει να είναι τουλάχιστον 30 ημέρες μεταγενέστερη της ημερομηνίας έναρξης',
