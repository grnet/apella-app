export default {
  ...
  'already.in.registry': 'Already in registry',
  ...
  'candidacy.label.pubs_note': 'Memo of scientific publications',
  ...
  'created_at_format.label': 'Created at',
  ...
  'disable.professor': 'Suspend professor',
  'disable.professor.self': 'Suspend account',
  'disable.professor.error': 'Error in suspending professor\'s participation',
  'disable.professor.message': '<p>The professor’s participation in the Apella registry will be suspended.</p><p>The suspended professor:</p><ul> <li>Cannot be added to new registries</li> <li>Cannot be added to new electing committees</li> <li>Will still have access to his/her account,</li> <li>Will still have access to all the registries/electing committees/evaluating committees he/she participates in</li> </ul><p>Would you like to proceed?</p>',
  'disable.professor.message.self': '<p>Your participation in the Apella registry will be suspended.</p><p>We remind you that:</p><ul> <li>You will still have access to your account.</li> <li>You will still participate in all the active election procedures in which you are already involved.</li> <li>It will not be possible for you to be added to any other registries.</li> <li>It will not be possible for you to be added to any other electing committees or evaluating committees.</li></ul> <p>Would you like to proceed?  </p> ',
  'disable.professor.success': 'Success in suspending professor',
  'disable.professor.title': 'Suspend professor’s participation',
  'disabled_at.label': 'Disable date',
  'disabled_by.label': 'Disabled by',
  ...
  'enable.professor': 'Unsuspend professor',
  'enable.professor.error': 'Error in unsuspending account',
  'enable.professor.message': 'Are you sure you want to continue?',
  'enable.professor.self': 'Unsuspend account',
  'enable.professor.success': 'Success in unsuspending account',
  'enable.professor.title': 'Unsuspend professor',
  'enable.professor.title.self': 'Unsuspend account',
  ...
  'error.for.users': 'Error for users',
  'existing.entries': 'Current Members',
  'exportPositionsCSV': 'Export positions',
  'exportProfCSV': 'Export gerneric registy',
  'exportRegistriesCSV': 'Export registries ',
  ...
  'fieldsets.labels.account_disabled': 'Disabled account',
  ...
  'fieldsets.labels.user_application_create.applicant': 'Create application',
  'fieldsets.labels.user_application_create.helpdesk': 'Create application',
  ...
  'issue_call.label': 'Call type',
  'issue_type.label': 'Issue type',
  'item.actions.label': 'Actions',
  'jira.Account Modification': 'Account Modification',
  'jira.Closed': 'Closed',
  'jira.Complaint': 'Complaint',
  'jira.Error': 'Error',
  'jira.General Information': 'General Information',
  'jira.In Progress': 'In Progress',
  'jira.Incoming': 'Incoming',
  'jira.Login': 'Login Issues',
  'jira.Open': 'Open',
  'jira.Outgoing': 'Outgoing',
  'jira.Registration': 'Registration',
  'jira.Reopened': 'Reopened',
  'jira.Resolved': 'Resolved',
  'jira.fieldset.helpdesk.label': 'Issue',
  'jira.fieldset.helpdesk.text': '',
  'jira.fieldset.user.label': 'Contact',
  'jira.fieldset.user.text': 'We will contact back',
  'jira.helpdesk.menu_label': 'Issues',
  'jira.title.label': 'Title',
  'jira.user.menu_label': 'Contact',
  'jira_resolution.': '',
  ...
  'leave.current': 'Currently on leave',
  'leave.upcoming': 'Upcoming',
  ...
  'position_type.Change Department': 'Relocation',
  ...
  'professor.is_disabled.prompt': 'Your participation in the Apella registry has been suspended. You can not be selected in new registries or new electing committees.',
  ...
  'prompt.applyNotElection.message': 'Before submitting your candidacy, please make sure that your profile is up to date<br> with all the documents you wish to include in your candidacy.<br> These documents will be copied from your profile to your candidacy.<br> <br>After submitting, you will not be able to edit the files of the candidacy.',
  'prompt.applyNotElection.title': 'Apply candidacy',
  ...
  'prompt.member.no_remove.message': 'You cannot delete the registry member, as long as he or she<br> participates in current electing procedures, as elector or member of evaluation committee.',
  ...
  'prompt.upgradeRole.message': 'Upload a CSV file to upgrade candidates to professors',
  'prompt.upgradeRole.title': 'Upgrade role',
  ...
  'pubs_note.label': 'Memo of scientific publications',
  'rank.label': 'Rank',
  ...
  'release.shibboleth': 'Release academic login',
  'release.shibboleth.error': 'Error in releasing academic login',
  'release.shibboleth.message': 'Are you sure you want to release the academic login?',
  'release.shibboleth.success': 'Success in releasing academic login',
  'release.shibboleth.title': 'Release academic login',
  'reporter.full_name_current.label': 'Reporter full name',
  'reporter_id_if_not_user.label': 'Reporter ID',
  ...
  'type.label': 'Type',
  'updated_at.label': 'Last updated at',
  'updated_at_format.label': 'Last updated at',
  'upgradeRole': 'upgrade',
  ...
  'user_application.Change Department': 'Relocation',
  ...
  'user_department.title_current.label': 'User department',
  'user_id.label': 'User ID',
  'user_institution.title_current.label': 'User institution',
  'username': 'Username',
