export default {
  ...
  '{description} is too short (minimum is {min} characters)': '\'{description}\' is too short (minimum {min} characters)',
  '{description} must be between {min} and {max} characters': '\'{description}\' must be between {min} and {max} characters',
  '{description} must be an integer': '\'{description}\' must be an integer',
  '{description} must be a number': '\'{description}\' must be a number',
