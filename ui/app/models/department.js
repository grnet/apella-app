...
export default DS.Model.extend({
  ...
  school: gen.belongsTo('school', { autocomplete: true, formAttrs: {optionLabelAttr: 'title_current'}}),
  institution: gen.belongsTo('institution', { autocomplete: true, formAttrs: {optionLabelAttr: 'title_current'}}),
