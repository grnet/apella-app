PERMISSION_RULES = [
    ...
    ('applications', 'create', 'professor', '*', '*', ''),
    ('applications', 'create', 'helpdeskadmin', '*', '*', ''),
    ('applications', 'list', 'helpdeskadmin', '*', '*', ''),
    ('applications', 'list', 'professor', '*', '*', ''),
    ('applications', 'list', 'helpdeskadmin', '*', '*', ''),
    ('applications', 'list', 'institutionmanager', '*', '*', ''),
    ('applications', 'list', 'assistant', '*', '*', ''),
    ('applications', 'retrieve', 'helpdeskadmin', '*', '*', ''),
    ('applications', 'retrieve', 'professor', '*', 'owned', ''),
    ('applications', 'retrieve', 'institutionmanager', '*', 'owned', ''),
    ('applications', 'retrieve', 'assistant', '*', 'owned', ''),
]
