PERMISSION_RULES = [
    ...
    ('registries', 'update', 'assistant', 'registry_set_decision_file', 'can_create', ''),
    ...
    ('registries', 'partial_update', 'assistant', 'registry_set_decision_file', 'can_create', ''),
    ('registries', 'update', 'helpdeskadmin', '*', '*', ''),
    ('registries', 'partial_update', 'helpdeskadmin', '*', '*', ''),
    ('registries', 'upload', 'institutionmanager', '*', '*', ''),
    ('registries', 'upload', 'assistant', '*', 'can_create', ''),
