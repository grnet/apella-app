PERMISSION_RULES = [
    ...
    ('assistants', 'update', 'institutionmanager', 'user/home_phone_number', 'owned', '4.3.7'),
    ...
    ('assistants', 'update', 'institutionmanager', 'user/mobile_phone_number', 'owned', '4.3.7'),
    ('assistants', 'update', 'institutionmanager', 'user/can_create_registries', 'owned', '4.3.7'),
    ('assistants', 'update', 'institutionmanager', 'user/can_create_positions', 'owned', '4.3.7'),
    ...
    ('candidacies', 'update', 'professor', '*', 'owned_open', '1.3.13'),
    ...
    ('positions', 'update', 'institutionmanager', 'electors', 'closed', '4.3.14'),
