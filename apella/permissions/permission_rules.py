PERMISSION_RULES = [
    ...
    ('candidacies', 'update', 'professor', 'state', 'draft', ''),
    ('candidacies', 'update', 'professor', 'self_evaluation_report', 'draft', ''),
    ('candidacies', 'update', 'professor', 'attachment_files', 'draft', ''),
    ('candidacies', 'update', 'candidate', 'state', 'owned_open', '3.3.7'),
    ('candidacies', 'update', 'candidate', 'state', 'draft', ''),
    ('candidacies', 'update', 'candidate', 'self_evaluation_report', 'draft', ''),
    ('candidacies', 'update', 'candidate', 'attachment_files', 'draft', ''),
    ...
    ('candidacies', 'partial_update', 'professor', 'state', 'draft', ''),
    ('candidacies', 'partial_update', 'professor', 'self_evaluation_report', 'draft', ''),
    ('candidacies', 'partial_update', 'professor', 'attachment_files', 'draft', ''),
    ('candidacies', 'partial_update', 'candidate', 'state', 'draft', ''),
    ('candidacies', 'partial_update', 'candidate', 'self_evaluation_report', 'draft', ''),
    ('candidacies', 'partial_update', 'candidate', 'attachment_files', 'draft', ''),
    ...
    ('departments', 'update', 'institutionmanager', '*', '*', '5.2.5'),
    ('departments', 'partial_update', 'institutionmanager', '*', '*', '5.2.5'),
