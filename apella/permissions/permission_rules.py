PERMISSION_RULES = [
    ...
    ('assistants', 'list', 'institutionmanager', '*', 'owned', '4.3.7'),
    ...
    ('candidacies', 'list', 'assistant', '*', 'owned', '4.3.16'),
    ('candidacies', 'retrieve', 'assistant', '*', 'owned', '4.3.16'),
    ('candidacies', 'create', 'candidate', '*', '*', '3.3.3'),
    ('candidacies', 'destroy', 'candidate', '*', 'owned, open', '3.3.7'),
    ('candidacies', 'list', 'candidate', '*', 'others_can_view', '3.3.5'),
    ('candidacies', 'list', 'candidate', '*', 'owned', '3.3.5'),
    ('candidacies', 'retrieve', 'candidate', '*', 'others_can_view', '3.3.5'),
    ('candidacies', 'retrieve', 'candidate', '*', 'owned', '3.3.5'),
    ('candidacies', 'list', 'candidate', 'candidate', 'owned', '3.3.5'),
    ('candidacies', 'retrieve', 'candidate', 'candidate', 'owned', '3.3.5'),
    ('candidacies', 'list', 'helpdeskadmin', '*', '*', '5.16'),
    ('candidacies', 'retrieve', 'helpdeskadmin', '*', '*', '5.17'),
    ('candidacies', 'partial_update', 'helpdeskadmin', 'active', 'after_closed, electors_meeting_open', '5.2.3.a'),
    ('candidacies', 'list', 'helpdeskuser', '*', '*', '5.16'),
    ('candidacies', 'retrieve', 'helpdeskuser', '*', '*', '5.17'),
    ('candidacies', 'list', 'institutionmanager', '*', 'owned', '4.3.16'),
    ('candidacies', 'retrieve', 'institutionmanager', '*', 'owned', '4.3.16'),
    ('candidacies', 'create', 'professors', '*', '*', '1.3.9'),
    ('candidacies', 'destroy', 'professors', '*', 'owned, open', '1.3.13'),
    ('candidacies', 'list', 'professors', '*', 'others_can_view', '1.3.3'),
    ('candidacies', 'list', 'professors', '*', 'owned', '1.3.3'),
    ('candidacies', 'list', 'professors', '*', 'participates', '1.3.3'),
    ('candidacies', 'retrieve', 'professors', '*', 'others_can_view', '1.3.5'),
    ('candidacies', 'retrieve', 'professors', '*', 'owned', '1.3.5'),
    ('candidacies', 'retrieve', 'professors', '*', 'participates', '1.3.5'),
    ('candidacies', 'list', 'professors', 'candidate', 'owned', '1.3.3'),
    ('candidacies', 'retrieve', 'professors', 'candidate', 'owned', '1.3.3'),
